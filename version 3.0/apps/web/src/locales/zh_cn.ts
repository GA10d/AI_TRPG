export const zhCn = {
  ...
  gameScreen: {
    ...
    multiAgentRepliesEyebrow: "多 Agent",
    multiAgentRepliesTitle: "本轮 Agent 回复",
    multiAgentRepliesCount: (ready: number, total: number) => `${ready}/${total} 条`,
    multiAgentRepliesEmpty: "当前会话不是多 Agent 模式，暂无 Agent 回复可展示。",
    ...
    multiAgentAgentReady: "已生成",
    multiAgentAgentPending: "等待生成",
    multiAgentDirectorQueued: "已排队",
    multiAgentDirectorRunning: "生成中",
    multiAgentDirectorFailed: "生成失败",
    multiAgentAgentEmpty: "本轮尚未产生该 Agent 的回复。",
    multiAgentDirectorEmpty: "Director 会在本轮提交后后台生成，完成后会显示在这里。",
    ...
    artAssetsTab: "美术资产",
    artAssetsEyebrow: "美术资产",
    artAssetsTitle: "剧本美术资产",
    artAssetsCount: (count: number) => `${count} 张图片`,
    loadingArtAssets: "正在加载当前剧本的美术资产...",
    artAssetsEmpty: "这个剧本暂时没有可展示的美术图片。",
    missingArtAssetContentInfo: "这个存档缺少内容目录信息，因此无法加载剧本美术资产。",
    artAssetsMainSection: "剧本文件",
    artAssetsOtherSection: "other 图集",
  ...
  gameSetupScreen: {
    ...
    fields: {
      ...
      comicIntervalLabel: "漫画生成间隔",
      comicIntervalHint: "首轮仍会生成一张；之后每隔多少轮自动生成一张，结局轮仍会补图。",
      logViewLabel: "日志显示",
    ...
    model: {
      ...
      comicInterval: (value: number) => `漫画节奏：每 ${value} 轮`,
